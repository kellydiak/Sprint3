...
class BDDTest {
    ...
    fun executePreparedStatement() {
        ...
        // 2️⃣ Prépare une requête SQL pour récupérer toutes les lignes de la table "entraineur"
        val sql = bdd.connectionBDD!!.prepareStatement("SELECT * FROM entraineur")
        ...
        // 5️⃣ Parcourt le résultat lignes par ligne
